...
import Bookhotel2 from "../../redux/hyderabadhotels/hyderabadActions/hyderabadaction2";//importing dispatch actions
import "C:/Users/269559/Desktop/react/case-study/node_modules/bootstrap/dist/css/bootstrap.min.css"//importing bootstrap
import CarouselImageOne from "../../images/themanoharhotel1.webp"//importing images of hotels
import CarouselImageTwo from "../../images/themanoharhotel2.jpg" //importing images of hotels
import CarouselImageThree from "../../images/themanoharhotel3.webp" //importing images of hotels
import CarouseImageFour from "../../images/themanoharhotel4.jpg"//importing images of hotels

function Hyderabadhotels2(){
  const noOfRooms2=useSelector(state=>state.hotels.noofrooms2)
  const navigate=useNavigate()// use to navigate to other components
  const dispatchAction=useDispatch()//action dispatched
  const [number,setNumber]=useState(1)

  const PriceCalculator=()=>{return (number*1500) }
  const handler=()=>{//event handler
    if (noOfRooms2>=number)
    {
      dispatchAction(Bookhotel2(number))//action dispatch
...
fontStyle: "normal",fontSize:"large",height:"1.2cm",paddingTop:"10px"}}>The Manohar Hotel</h1><br></br>
...
420 m
          ...
          <div>
          <p style={{fontWeight:"bolder",textAlign:"center",fontFamily:"'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif"}}> No of Rooms Available: {noOfRooms2}</p>
...
export default Hyderabadhotels2// default export