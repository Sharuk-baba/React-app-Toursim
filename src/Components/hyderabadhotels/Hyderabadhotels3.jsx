...
import { useSelector,useDispatch } from 'react-redux'//import selectors
import {useState} from 'react'//import usestate
import { useNavigate } from "react-router";
import Bookhotel3 from "../../redux/hyderabadhotels/hyderabadActions/hyderabadaction3";//
import "C:/Users/269559/Desktop/react/case-study/node_modules/bootstrap/dist/css/bootstrap.min.css"
import CarouseImageOne from "../../images/theparkhyderabad.jpg"//importing images 
import CarouselImageTwo from "../../images/theparkhyderabad1.jpg" //importing images 
import CarouselImageThree from "../../images/theparkhyderabad2.jpg" //importing images 
import CarouselImageFour from "../../images/theparkhyderabad3.webp"//importing images 

function Hyderabadhotels3(){
  const noOfRooms3=useSelector(state=>state.hotels.noofrooms3)
  const navigate=useNavigate()// use to navigate to other components
  const dispatchAction=useDispatch()//action dispatched
  const [number,setNumber]=useState(1)

  const PriceCalculator=()=>{return (number*2000) }
  
  const handler=()=>{//event handlers
    if (noOfRooms3>=number)
    {
      dispatchAction(Bookhotel3(number))
      alert(`Successfully Booked ${number} Rooms`)
    }
    else{
      alert("You have Entered more Number of Rooms than Available")
    }
  }
    ...
    return(
        <div>
            <h1  className="sticky-top"style={{backgroundColor:"brown",width:"100%",color:"azure",position:"fixed",textAlign:"center",float:"inline-end",fontFamily:"Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif",textTransform: "uppercase",

fontStyle: "normal",fontSize:"large",height:"1.2cm",paddingTop:"10px"}}>The Park Hyderabad Hotel</h1><br></br>
          ...
          <div style={{borderStyle:"solid",backgroundColor:"lightsteelblue",borderColor:"black",boxSizing:"content-box",height:"500px",marginLeft:"10px",marginRight:"10px"}}>
...
420 m
          ...
          <div>
          <p style={{fontWeight:"bolder",textAlign:"center",fontFamily:"'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif"}}> No of Rooms Available: {noOfRooms3}</p>
          ...
          <p style={{fontFamily:"'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif",textAlign:"center",fontWeight:"bold"}}>Price of {number} room(s) : ₹<PriceCalculator/> </p>
           <button style={{width:"200px",marginTop:"10px",fontFamily:"'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif",marginLeft:"400px",marginBottom:"20px"}} onClick={handler}>Book {number} Rooms</button>
...
export default Hyderabadhotels3//default export