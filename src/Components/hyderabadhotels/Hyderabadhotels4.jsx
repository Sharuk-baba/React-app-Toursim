...
import Carousel from 'react-bootstrap/Carousel';//import carosel
import { useSelector,useDispatch } from 'react-redux'
import {useState} from 'react'
import Bookhotel4 from "../../redux/hyderabadhotels/hyderabadActions/hyderabadaction4";
import { useNavigate } from "react-router";
import "C:/Users/269559/Desktop/react/case-study/node_modules/bootstrap/dist/css/bootstrap.min.css"
import CarouseImageOne from "../../images/lemontreehotel.jpg" //importing images
import CarouselImageTwo from "../../images/lemontreehotel1.jpg" //importing images
import CarouselImageThree from "../../images/lemontreehotel2.jpg" //importing images
import CarouselImageFour from "../../images/lemontreehotel3.webp"//importing images


function Hyderabadhotels4(){
  const noOfRooms4=useSelector(state=>state.hotels.noofrooms4)
  const navigate=useNavigate()// use to navigate to other components
  const dispatchAction=useDispatch()//actions 
  const [number,setNumber]=useState(1)//use state hook to set value

  const PriceCalculator=()=>{return (number*3000) }
  
  const handler=()=>{//handler
    if (noOfRooms4>=number)//condtion
    {
      dispatchAction(Bookhotel4(number))
    ...
    return(//front end code
        <div>
            <h1  className="sticky-top"style={{backgroundColor:"brown",width:"100%",textAlign:"center",color:"azure",position:"fixed",float:"inline-end",fontFamily:"Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif",textTransform: "uppercase",

fontStyle: "normal",fontSize:"large",height:"1.2cm",paddingTop:"10px"}}>Lemon Tree Hotel</h1><br></br>
...
420 m
          ...
          <div>
          <p style={{fontWeight:"bolder",textAlign:"center",fontFamily:"'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif"}}> No of Rooms Available: {noOfRooms4}</p>
          ...
          <p style={{fontFamily:"'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif",textAlign:"center",fontWeight:"bold"}}>Price of {number} room(s) : ₹<PriceCalculator/> </p>
           <button style={{width:"200px",marginTop:"10px",fontFamily:"'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif",marginLeft:"400px",marginBottom:"30px"}} onClick={handler}>Book {number} Rooms</button>
...
export default Hyderabadhotels4//defaultexport